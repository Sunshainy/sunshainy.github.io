      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-8 flex justify-center">
          <div className="inline-block border-2 border-[var(--color-accent-red)] px-8 py-6">
            <blockquote className="text-3xl md:text-4xl leading-relaxed text-white max-w-3xl" style={{ fontFamily: 'Futura PT Medium, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, sans-serif' }}>
        ...
        <div className="mt-8 text-lg text-[var(--color-text-secondary)]" style={{ fontFamily: 'Futura PT Medium, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, sans-serif' }}>
