        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-[var(--color-text-secondary)]">
              Наши постановки создаются на основе тщательного исторического анализа 
              и проводятся на аутентичных локациях, превращая каждое представление 
              в незабываемое иммерсивное путешествие в прошлое.
            </p>
          </div>
